...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/portfolio/";
          ...
          title: "CV",
          description: "This is what I have achieved over the years. It ain&#39;t much, but it&#39;s honest work.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/portfolio/books/the_stranger/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/portfolio/assets/pdf/Arjun_Lenan_Sandhya.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
